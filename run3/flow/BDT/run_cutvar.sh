...
export config_flow="/home/wuct/ALICE/local/DmesonAnalysis/run3/flow/config/config_flow_D0_Single_pT_6080.yml" # <-----------------------------------------------------------------------------------------------
export anres_dir="/home/wuct/ALICE/local/Results/BDT/k6080/pre/AnRes/AnalysisResults_pt11.root \
/home/wuct/ALICE/local/Results/BDT/k6080/pre/AnRes/AnalysisResults_pt12.root
" # <-----------------------------------------------------------------------------------------------
export output_dir="/home/wuct/ALICE/local/Results/BDT/k6080/approve_2_11/uncorrelated_pass3" # uncorrelated uncorrelated_pass3 <-----------------------------------------------------------------------------------------------
export cent="k6080"
export vn_method="sp"
export res_file="/media/wuct/wulby/ALICE/AnRes/resolution/output_reso/resosp6080l_PASS4_full_PbPb_Reso.root"
export suffix="pt8_12" # <-----------------------------------------------------------------------------------------------
