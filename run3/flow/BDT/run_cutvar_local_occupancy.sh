...
#----------
export config_flow="/home/wuct/ALICE/local/DmesonAnalysis/run3/flow/config/config_flow_3050l_PASS4_full_PbPb.yml"
export anres_dir="/media/wuct/wulby/ALICE/AnRes/D0_flow/pass4/Occupancy/event/AnalysisResults_data_med_evesel.root"
export output_dir="/home/wuct/ALICE/local/Results/BDT/k3050/third_app/occu" # full/corrected full/uncorrected
export cent="k3050"
export vn_method="sp"
export res_file="/media/wuct/wulby/ALICE/AnRes/resolution/output_reso/resosp3050l_PASS4_full_PbPb_Reso.root"
export suffix="ops_order" # _ will be added automatically
