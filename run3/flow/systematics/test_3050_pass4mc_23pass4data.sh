...
export config_default="/home/wuct/ALICE/local/DmesonAnalysis/run3/flow/config/2024/k3050/config_flow_pass4_mc_ptsmearing1p5_vsphi_full.yml" # bdt cut of corr and uncorr, skip_cut, sysematic
export output_dir="/home/wuct/ALICE/local/Results/BDT/2024/k3050/pass4_mc_ptsmearing1p5_vsphi_2024_corrPID"
...
python3 /home/wuct/ALICE/local/DmesonAnalysis/run3/flow/BDT/run_cutvar.py ${output_dir}/config_sys/reference/config_uncorrelated.yml \
        --use_preprocessed --do_calc_weights --do_make_yaml --do_projections --do_efficiency --do_vn --do_sys_trail
# # # # python3 /home/wuct/ALICE/local/DmesonAnalysis/run3/flow/BDT/run_cutvar.py ${output_dir}/config_sys/reference/config_uncorrelated.yml \
...
python3 /home/wuct/ALICE/local/DmesonAnalysis/run3/flow/BDT/run_cutvar.py ${output_dir}/config_sys/reference/config_correlated.yml \
        ...
        --do_frac_cut_var --do_data_driven_frac --do_merge_images --do_sys_trail
...
# python3 /home/wuct/ALICE/local/sys_dev/DmesonAnalysis/run3/flow/systematics/compute_syst_multitrial_bdt.py $output_dir/trails/all_pt $output_dir/pre_sys/cutvar_combined -o $output_dir -p
