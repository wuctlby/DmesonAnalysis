...
export config_default="/home/wuct/ALICE/local/DmesonAnalysis/run3/flow/config/config_flow_D0_3050_mother.yml" # default configuration file
...
export proj_default="/home/stefano/flowD/output/pass3/Dplus/sp/proj_mc/proj_mc_LHC23zzh_pass3_Dplus_skimmed_FULL_2060_train237912.root"
...
export cent="k3050" #TODO: fix this into hard-coded
export skip_resolution="--skip_resolution" # TODO: fix this into hard-coded
export vn_method="sp"
export res_file="/home/stefano/flowD/output/pass3/Resolution/resosp_pass3_3050.root"
export skip_efficiency="--skip_efficiency" # TODO: fix this into hard-coded
export wagon_id=""
...
echo "python3 make_yaml_for_syst.py $config_default -m $config_modifies -o $output_dir -mb"
