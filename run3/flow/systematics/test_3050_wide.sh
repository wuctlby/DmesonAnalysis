#!/bin/bash
export config_modifies="/home/wuct/ALICE/local/DmesonAnalysis/run3/flow/systematics/modifications_config_fit_k3050_wide.yml"
export config_default="/home/wuct/ALICE/local/DmesonAnalysis/run3/flow/config/config_flow_k3050_fd.yml" # bdt cut of corr and uncorr, skip_cut, sysematic
export output_dir="/home/wuct/ALICE/local/Results/BDT/2024/k3050/pass4_mc_wide"
